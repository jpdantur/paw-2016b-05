...
define([], function () {
    ...
    'Digits.SellForm.price': 'El art\\u00EDculo no puede ser gratis ni costar mas que mil millones',
    'Email.ProfileForm.email': 'El formato del email es inv\\u00E1lido',
    'Email.RegisterForm.email': 'El formato del email es inv\\u00E1lido',
    'Email.SellForm.email': 'El formato del email es inv\\u00E1lido',
    ...
    'NotEmpty.CommentForm.content': 'La rese\\u00F1a no puede estar vacia',
    ...
    'PasswordMatch.ChangePasswordForm.repeatPassword': 'Las contrase\\u00F1as no coinciden',
    'PasswordMatch.RegisterForm.repeatPassword': 'Las contrase\\u00F1as no coinciden',
    'Pattern.RoleForm.slug': 'El nombre del slug debe contener caracteres en mayuscula, numeros, \'-\' o \'_\' sin espacios',
    'Size.CategoryForm.name': 'El nombre debe contener entre {min} y {max} caract\\u00E9res',
    'Size.CommentForm.content': 'La rese\\u00F1a debe contener hasta {max} caract\\u00E9res',
    'Size.CommentForm.contentFixed': 'La rese\\u00F1a debe contener hasta 300 caract\\u00E9res',
    'Size.RegisterForm.firstName': 'Su nombre debe contener entre {min} y {max} caract\\u00E9res',
    'Size.RegisterForm.lastName': 'Su apellido debe contener entre {min} y {max} caract\\u00E9res',
    'Size.RegisterForm.password': 'Su contrase\\u00F1a debe contener entre {min} y {max} caract\\u00E9res',
    'Size.RegisterForm.username': 'Su usuario debe contener entre {min} y {max} caract\\u00E9res',
    'Size.RoleForm.name': 'El nombre del rol debe contener entre {min} y {max} caract\\u00E9res',
    'Size.RoleForm.slug': 'El nombre del slug debe contener entre {min} y {max} caract\\u00E9res',
    'Size.SellForm.name': 'El nombre del art\\u00EDculo debe contener entre {min} y {max} caract\\u00E9res',
    'UsernameExists.RegisterForm.username': 'El usuario ya existe',
    'WrongPassword.ChangePasswordForm.oldPassword': 'Esta no era su contrase\\u00F1a',
    'admin.categories.create.action': 'Crear',
    'admin.categories.create.cancel': 'Cancelar',
    'admin.categories.create.headline': 'Crear Categor\\u00EDa',
    ...
    'admin.categories.rename.headline': 'Renombrando categor\\u00EDa',
    'admin.categories.rename.name': 'Nombre',
    'admin.categories.rename.success': 'Se actualiz\\u00F3 correctamente',
    'admin.categories.rename.successInfo': 'Esta ventana se cerrara automaticamente',
    'admin.category.add': 'Nueva Subcategor\\u00EDa',
    'admin.category.headline': 'Categor\\u00EDas',
    'admin.category.rename': 'Renombrar',
    'admin.index.categories': 'Categor\\u00EDas',
    'admin.index.headline': 'Panel de Control',
    'admin.index.items': 'Art\\u00EDculos',
    ...
    'admin.users.create.password': 'Contrase\\u00F1a',
    'admin.users.create.repeatPassword': 'Repetir Contrase\\u00F1a',
    ...
    'edit.details.categoryChosen': 'Usetd eligi\\u00F3:',
    'edit.headline': 'Editando',
    'edit.images': 'Im\\u00E1genes',
    'index.categories': 'Categor\\u00EDas',
    ...
    'index.headline': '\\u00BFQu\\u00E9 desea Comprar?',
    'index.login': 'Ingresar',
    'index.promoted': 'M\\u00E1s Vendidos',
    'index.register': 'Registrate',
    'index.search': 'Buscar',
    'index.sell': 'Vender',
    'index.user.items': 'Mis Art\\u00EDculos',
    'index.user.logout': 'Cerrar Sesi\\u00F3n',
    ...
    'item.bought.viewStatus': 'Vea el estado aqu\\u00ED',
    'item.buy': 'Comprar',
    'item.comment': 'Rese\\u00F1a',
    'item.commentAction': 'Enviar',
    'item.commentEmpty': 'No hay rese\\u00F1as aun',
    'item.comments': 'Rese\\u00F1as',
    'item.description': 'Descripci\\u00F3n',
    'item.favourite': 'Marcar como favorito',
    'item.item': 'Estado del Art\\u00EDculo',
    'item.new': 'Nuevo',
    ...
    'login.error.wrongData': 'Usuario o contrase\\u00F1a incorrectos',
    'login.field.password': 'Contrase\\u00F1a',
    'login.field.rememberMe': 'Recordarme',
    'login.field.user': 'Usuario',
    'login.form.noUserQuestion': '\\u00BFNo tiene un usuario a\\u00FAn?',
    'login.form.register': 'Reg\\u00EDstrese',
    'login.recover.help': 'Ingrese su correo y le enviaremos las instrucciones para recuperar su contrase\\u00F1a',
    'login.recover.invalidLink': 'El link es inv\\u00E1lido',
    'login.recover.maxTime': 'El tiempo m\\u00E1ximo para renovar su contrase\\u00F1a es de 3 horas',
    'login.recover.question': '\\u00BFOlvid\\u00F3 su contrase\\u00F1a?',
    'login.recover.recover': 'Recuperar',
    'login.recover.recoverIt': 'Recup\\u00E9rela',
    'login.submit.login': 'Iniciar Sesi\\u00F3n',
    ...
    'profile.favourites.table.item': 'Art\\u00EDculo',
    ...
    'profile.modal.scores.scoresFrom': 'Puntuaci\\u00F3n del',
    'profile.modal.scores.scoringTo': 'Puntuando al',
    'profile.modal.scores.seller': 'Vendedor',
    'profile.modal.scores.stillNoScore': 'Esta venta no ha sido puntuada a\\u00FAn',
    'profile.modal.scores.success': 'Puntuaci\\u00F3n registrada exitosamente',
    'profile.modal.scores.title': 'Viendo Puntajes',
    'profile.modal.scores.toScore': 'Puntuar',
    'profile.modal.scores.voidContent': 'Contenido vac\\u00EDo',
    'profile.modal.scores.yourScore': 'Su puntuaci\\u00F3n',
    'profile.password.form.current': 'Contrase\\u00F1a Actual',
    'profile.password.form.new': 'Nueva Contrase\\u00F1a',
    'profile.password.form.repeat': 'Repetir Nueva Contrase\\u00F1a',
    'profile.password.title': 'Contrase\\u00F1a',
    'profile.public.buyer': 'comprador',
    'profile.public.nopurchases': 'no ha comprado ningun articulo a\\u00FAn',
    'profile.public.nosales': 'no ha vendido ningun articulo a\\u00FAn',
    'profile.public.score.buyer': 'Puntaje como comprador',
    'profile.public.score.buyer.acceptance': 'Porcentaje de Aceptaci\\u00F3n',
    ...
    'profile.public.score.seller.recommendation': 'Porcentaje de Recomendaci\\u00F3n',
    'profile.public.score.seller.rejectedSales': 'Ventas Rechazadas',
    'profile.public.seller': 'vendedor',
    'profile.public.seller.items': 'Art\\u00EDculos Publicados',
    ...
    'profile.purchases.table.item': 'Art\\u00EDculo',
    ...
    'profile.sales.sell.approving': 'aprovando su venta',
    'profile.sales.sell.confirmation': '\\u00BFEst\\u00E1 seguro que desea',
    'profile.sales.sell.confirmation2': 'esta venta?',
    'profile.sales.sell.error': 'Hubo un error',
    'profile.sales.sell.pause': 'pausar',
    'profile.sales.sell.pauseBtn': 'Pausar Publicaci\\u00F3n',
    'profile.sales.sell.pausing': 'pausando su publicacion',
    'profile.sales.sell.publishConfirmation': '\\u00BFEst\\u00E1 seguro que desea publicar este art\\u00EDculo?',
    ...
    'profile.sales.sell.resumeBtn': 'Reanudar Publicaci\\u00F3n',
    'profile.sales.sell.resuming': 'resumiendo su publicaci\\u00F3n',
    'profile.sales.sell.success': 'Acci\\u00F3n realizada con \\u00E9xito',
    'profile.sales.success': 'APROBAR',
    'profile.sales.table.buyer': 'Comprador',
    'profile.sales.table.date': 'Fecha',
    'profile.sales.table.item': 'Art\\u00EDculo',
    ...
    'register.form.login': 'Ingrese aqu\\u00ED',
    'register.form.mail': 'E-mail',
    'register.form.name': 'Nombre',
    'register.form.repeatPassword': 'Repetir contrase\\u00F1a',
    ...
    'search.filters.order.alphabetic': 'Alfab\\u00E9tico',
    ...
    'search.filters.order.recentDesc': 'M\\u00E1s Reciente',
    'search.filters.order.soldAsc': 'Menos Vendidos',
    'search.filters.order.soldDesc': 'M\\u00E1s Vendidos',
    'search.filters.pagination.modifiers.amount': 'Art\\u00EDculos',
    'search.filters.pagination.modifiers.of': 'de',
    'search.filters.pagination.modifiers.perPage': 'resultados por p\\u00E1gina',
    ...
    'search.filters.pagination.pagers.next': 'Pr\\u00F3xima',
    ...
    'search.none': 'No hay resultados para su b\\u00FAsqueda',
    'search.searchResults': 'Resultados de la b\\u00FAsqueda',
    'sell.back': 'Volver',
    'sell.edit.details.success': '\\u00A1Enhorabuena! Su ar\\u00EDculo se actualiz\\u00F3 exitosamente.',
    'sell.edit.return': 'Volver a mis art\\u00EDculos',
    'sell.field.category': 'Categor\\u00EDa',
    'sell.field.contactEmail': 'Email de Contacto',
    'sell.field.description': 'Descripci\\u00F3n',
    ...
    'sell.pickCategory': 'Por favor elija una categor\\u00EDa',
