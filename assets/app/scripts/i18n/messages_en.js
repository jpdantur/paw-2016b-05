...
define([], function () {
    ...
    'profile.public.nosales': 'has not selled an item yet',
    ...
    'search.filters.price.between': 'Between ${0} and ${1}',
    'search.filters.price.from': 'From ${0}',
    'search.filters.price.max': 'Max',
    'search.filters.price.min': 'Min',
    'search.filters.price.to': 'Up to ${0}',
