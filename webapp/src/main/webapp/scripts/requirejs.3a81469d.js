...
!function(global, setTimeout) {
    ...
    function newContext(contextName) {
        ...
        function hasPathFallback(id) {
            ...
            if (pathConfig && isArray(pathConfig) && pathConfig.length > 1) return pathConfig.shift(), 
        ...
        return handlers = {
                    ...
                    if (this.inited) {
                        if (this.error) this.emit("error", this.error); else if (!this.defining) {
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                ...
                                if (this.exports = exports, this.map.isDefine && !this.ignore && (defined[id] = exports, 
                                req.onResourceLoad)) {
                                    var resLoadMaps = [];
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(pluginMap), on(pluginMap, "defined", bind(this, function(plugin) {
                    ...
                    }) || ""), normalizedMap = makeModuleMap(map.prefix + "!" + name, this.map.parentMap, !0), 
            ...
            configure: function(cfg) {
                if (cfg.baseUrl && "/" !== cfg.baseUrl.charAt(cfg.baseUrl.length - 1) && (cfg.baseUrl += "/"), 
            ...
            makeRequire: function(relMap, options) {
                ...
                return options = options || {}, mixin(localRequire, {
                    ...
                    }), delete context.defQueueMap[id], mod && (mod.events.defined && (undefEvents[id] = mod.events), 
                    cleanRegistry(id));
                }), localRequire;
            },
            ...
            nameToUrl: function(moduleName, ext, skipExt) {
                ...
                if (req.jsExtRegExp.test(moduleName)) url = moduleName + (ext || ""); else {
                    ...
                    url = syms.join("/"), url += ext || (/^data\:|^blob\:|\?/.test(url) || skipExt ? "" : ".js"), 
    ...
    if (void 0 === define) {
        ...
        req.onError = defaultOnError, req.createNode = function(config, moduleName, url) {
            ...
            node.attachEvent("onreadystatechange", context.onScriptLoad)), node.src = url, config.onNodeCreated && config.onNodeCreated(node, config, moduleName, url), 
